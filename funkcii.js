...
// const getSortedUniqueSkills = (array) => array.reduce((accum,elem) => (accum += {['skills']: elem.skills }),'') 
// ({['index']: i }));

const getSortedUniqueSkills = (array) => array.reduce(function (accum, elem) {
  
  accum.push(elem.skills)
  return accum
}, [])
