...
//  Создание анонимных объектов: ПРИМЕР:
...
////Такой способ(создание анон обект ) - ({['name']: name }) Позволяет вернут масив ОБЬЕКТОВ а не просто масив имен.
...
// const calculateTotalBalance = array => array.reduce((accum, { balance }) => accum += balance, 0)  //// решение стрелками

// // 0 - это значение accum по умолчанию

// const calculateTotalBalance = array => array.reduce(function (accum, elem) {   //// решение стрелками + клас. функц.
    
//   return accum += elem.balance
//   },0)
...
// const getNamesSortedByFriendsCount = (array) => [...array].sort((perv, next) => perv.friends.length - next.friends.length)
//     // [...array] - распыляем - делаем копию что бы не менят исходный масив
//     // 
//   .map(({name}) => name) 
...
/*>>>>>> Если параметров нет а аргументов несколько или масив, или масив обьектов, их можно распылить ...args */
// const tra = (...args) => console.log(args)
// tra(1,2,3,4,4) //[1, 2, 3, 4, 4]